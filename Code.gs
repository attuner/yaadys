...
function setupDatabase() {
  ...
  if (menuSheet.getLastRow() === 1) {
    const defaultMenu = [
      ...
      ["ITEM-105", "Specials", "Earthen Claypot Spiced Buttermilk", "Churned A2 cultured yogurt infused with crushed ginger, fresh curry leaves, coriander seeds, and Himalayan rock salt.", "Probiotic", 45, "https://images.unsplash.com/photo-1556881286-fc6915169721?w=600&auto=format&fit=crop&q=80", true, 5, "Cal: 60kcal | Protein: 3g | Fiber: 0.5g"]
    ];
